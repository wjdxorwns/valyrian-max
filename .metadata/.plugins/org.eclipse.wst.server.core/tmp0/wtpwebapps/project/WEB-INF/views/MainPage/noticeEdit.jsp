...
<body>
    ...
    <main>
        ...
        <section class="notice-form">
            ...
            <form action="${pageContext.request.contextPath}/notice/update" method="post" enctype="multipart/form-data" id="editForm">
                ...
                <div class="form-group">
                    ...
                    <select id="importance" name="importance" required>
                        <option value="일반" <c:if test="${board.importance == '일반'}">selected</c:if>>일반</option>
                        <option value="중요" <c:if test="${board.importance == '중요'}">selected</c:if>>중요</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <c:if test="${not empty board.f_name}">
                        <div class="current-image">
                            <p>현재 이미지:</p>
                            <img src="${pageContext.request.contextPath}/Uploads/${board.f_name}" alt="현재 이미지" />
                            <div class="image-options">
                                <div class="keep-image-checkbox">
                                    <input type="checkbox" id="keepImage" name="keepImage" value="true" checked>
                                    <label for="keepImage">현재 이미지 유지</label>
                                </div>
                                <p class="hint">(체크 해제 시 이미지가 삭제됩니다. 새 이미지를 업로드하면 기존 이미지는 대체됩니다.)</p>
                            </div>
                        </div>
                    </c:if>
                </div>
                <div class="action-buttons">
                    ...
                    <button type="button" class="delete-btn" onclick="confirmDelete(${board.board_id})">삭제</button>
