				...
				<ul class="nav-menu">
					<li class="nav-item"><a href="HumanResourcesManagement">인사
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/resignedEmployees">퇴직자 정보 관리</a></li>
							<li><a href="/empDataRegister">신규 직원 등록</a></li>
						</ul></li>

					<li class="nav-item"><a href="/adminPay">급여 관리</a>
						<ul class="dropdown-menu">
							<li><a href="/admin_pay_list">직원 급여 리스트</a></li>
							<li><a href="/PayrollManagement">개인 급여 명세서 조회</a></li>
						</ul></li>
					...
					<li class="nav-item"><a href="LeaveManagement">권한 관리</a>
						<ul class="dropdown-menu">
							<li><a href="/Permission">사용자 권한 설정</a></li>
						</ul></li>
