					...
					<c:choose>
						<c:when test='${sessionScope.permissionvo.can_access_salary eq 1 or sessionScope.employeeVO.dept_name eq "슈퍼관리자"}'>
							<li class="nav-item"><a href="/adminPay">급여 관리</a>
								<ul class="dropdown-menu">
									<li><a href="/paylist">직원 급여 리스트</a></li>
						...
						<c:otherwise>
							<li class="nav-item">
								<a href="/payrollList" onclick="alert('급여 관리 권한이 없습니다.'); return false;">급여 관리</a>
								<ul class="dropdown-menu">
									<li><a href="/payrollList" onclick="alert('급여 관리 권한이 없습니다.'); return false;">직원 급여 리스트</a></li>
