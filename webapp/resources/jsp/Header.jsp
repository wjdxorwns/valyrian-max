				...
				<ul class="nav-menu">
					<li class="nav-item"><a href="HumanResourcesManagement">인사
						...
						<ul class="dropdown-menu">
							<li><a href="/hrTransfer">근무지 정보 관리</a></li>
							<li><a href="/hrRetirement">직원 현황 관리</a></li>
							<li><a href="/hrManagement">퇴직자 정보 관리</a></li>
							<li><a
								href="/PersonnelManagement/EmpManagement/empDataRegister">신규
									직원 등록</a></li>
						</ul></li>

					<li class="nav-item"><a href="PayrollManagement">급여 관리</a>
						<ul class="dropdown-menu">
							<li><a href="/payrollList">개인 급여 명세서 조회</a></li>
							<li><a href="/payrollGrade">급여 조정 및 명세서 발행</a></li>
						</ul></li>
					...
					<li class="nav-item"><a href="LeaveManagement">권한 관리</a>
						<ul class="dropdown-menu">
							<li><a href="/leaveList">사용자 권한 설정</a></li>
						</ul></li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<ul class="notification-list">
					...
					<%-- <li class="no-notifications">새로운 알림이 없습니다.</li> --%>
				</ul>
			</div>
		</div>
	</div>
