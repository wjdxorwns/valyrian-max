		...
		<form action="">
			...
			<div id="standby">
				...
				<table>
					<thead>
						<tr>
							<th style="width:150px;">휴가ID</th><th>부서</th><th>직급</th><th>이름</th><th>사원id</th><th>기간</th><th>결제</th><th>비고(사유)</th>
						</tr>
					</thead>
					<tbody>
						...
						<c:forEach var="entry" items="${vacationMap}">
							...
							<tr onclick="modal">
								...
								<td><input type="text" naem="comment_${entry.value.vacation_id}" value="${entry.value.comment }"></td>
							</tr>
							</c:if>
						</c:forEach>
							</c:otherwise>
				...
				<div class="detail-content">
					...
					<table>
						<tbody>
							...
							<tr>
								<th>결제</th>
								<td colspan="2" id="detaile_status">
							...
							<tr>
								<th>비고(사유)</th>
								<td colspan="2" id="detaile_comment">
									<input type="text" name="modal_comment" value="">
								</td>
							</tr>
						</tbody>
						<tfoot>
