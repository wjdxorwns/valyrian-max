				...
				.ajax({
					...
					success : function(response) {
						...
						if (noticeList && noticeList.length > 0) {
							...
							$
									.each(
											...
											function(index, notice) {
												console.log("처리 중인 공지사항:",
														notice); // 디버깅용: 각 공지사항 객체 확인
												let importanceBadge = notice.importance === '중요' ? '<span class="importance-badge">중요</span>'
														: '';

												// created_at이 null 또는 undefined일 경우 'N/A' 처리 (필수)
												let createdAt = notice.created_at ? notice.created_at
														: 'N/A';

												// username이 null 또는 undefined일 경우 '알 수 없음' 처리 (필수)
												let username = notice.username ? notice.username
														: '알 수 없음';

												// 백틱 대신 문자열 연결 사용
												let listItem = '';
												listItem += '<li class="post-item">';
												listItem += '    <a href="notice/detail?id='
														+ notice.board_id
														+ '">';
												listItem += '        <h3 class="post-title">'
														+ notice.title
														+ '</h3>';
							...
							postList
									.append('<li class="post-item"><p>공지사항이 없습니다.</p></li>');
						}
					},
					error : function(xhr, status, error) {
						...
						$('.post-list')
								.html(
										'<li class="post-item"><p>공지사항을 불러오는 중 오류가 발생했습니다.</p></li>');
					}
				});
	}
</script>
		...
		<div class="content">
			...
			<div class="visual">
				<div class="container">
					<div class="txt-box">
						<h2 class="txt-main">
							트라이어드 솔루션<span class="strong">비즈니스 플랫폼</span>
						</h2>
						<p class="txt-sub">
							혁신적인 솔루션으로<br>당신의 비즈니스를 한 단계 업그레이드하세요.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="container">
					<ul class="shortcut-list clearfix">
						<li class="shortcut-list-item"><a
							href="calendar?emp_idx=${sessionScope.employeeVO.emp_idx}">
								<h3 class="txt-main">캘린더</h3>
								<p class="txt-sub">
									트라이어드 솔루션의 캘린더로<br>일정을 효율적으로 관리하세요.
								</p>
								<p class="img-box">
									<span class="screen-hidden"></span>
								</p>
						</a></li>
						<li class="shortcut-list-item"><a href="attendance?emp_idx=${sessionScope.employeeVO.emp_idx}">
								<h3 class="txt-main">근태 관리</h3>
								<p class="txt-sub">
									출근 및 퇴근 시간을<br>실시간으로 간편하게 기록하세요.
								</p>
								<p class="img-box">
									<span class="screen-hidden"></span>
								</p>
						...
						<li class="shortcut-list-item"><a href="PermissionRequest?emp_idx=${sessionScope.employeeVO.emp_idx}">
								...
								<p class="txt-sub">
									빠르고 안전한<br>전자 결제 승인 프로세스를 경험하세요.
								</p>
								<p class="img-box">
									<span class="screen-hidden"></span>
								</p>
						</a></li>
						<li class="shortcut-list-item"><a href="notice?emp_idx=${sessionScope.employeeVO.emp_idx}">
								<h3 class="txt-main">공지사항</h3>
								<p class="txt-sub">
									최신 소식과 자료를<br>쉽게 공유하고 확인하세요.
								</p>
								<p class="img-box">
									<span class="screen-hidden"></span>
								</p>
			...
			<div class="article info-step">
				<div class="container clearfix">
					<div class="txt-box">
						...
						<p class="txt-sub">
							간단한 절차로<br>트라이어드 솔루션의 모든 서비스를<br>시작할 수 있습니다.
						</p>
					</div>
					<div class="graphic-box clearfix">
						<div class="div-step">
						...
						<div class="div-step">
							...
							<p class="step-icon">
								<img src="resources/images/icons8-적용-스킨-타입-7-48.png"
									alt="적용 아이콘">
							</p>
							<p class="step-txt-sub">
				...
				<div class="container clearfix">
					...
					<div class="graphic-box clearfix">
						<div class="info-details">
							<p>
								<strong>회사명:</strong> 트라이어드 솔루션 주식회사
							</p>
							<p>
								<strong>주소:</strong> 서울특별시 강남구 테헤란로 123, 5층 (역삼동, 트라이어드 타워)
							</p>
							<p>
								<strong>전화번호:</strong> 02-9876-5432
							</p>
							<p>
								<strong>이메일:</strong> contact@triadsolutions.com
							</p>
						</div>
						<div class="map-container">
							<iframe
								src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.365763499896!2d127.0317673152096!3d37.49939597981169!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca3f0d2b0c5b7%3A0x7e8f2b1a3c4d5e6f!2z7ISc7Jq47Yq567OE7IucIOq4iOyKpO2EsO2BrOu2gCDthYztgqTsmrTsnbwgMTIz!5e0!3m2!1sko!2skr!4v1698779876543!5m2!1sko!2skr"></iframe>
						</div>
					</div>
				</div>
			</div>
