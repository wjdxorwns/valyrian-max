...
<body>
	...
	<main>
		<section class="employee-section">
			...
			<div>
				<form id="searchForm" action="<c:url value='/hrRetirement' />"
					method="get">
					<div class="search-form">
						<select class="employee" name="searchType">
							<option value="emp_name"
								<c:if test="${param.searchType == 'emp_name'}">selected</c:if>>직원명</option>
							<option value="emp_id"
								<c:if test="${param.searchType == 'emp_id'}">selected</c:if>>직원번호</option>
							<option value="dept_name"
								<c:if test="${param.searchType == 'dept_name'}">selected</c:if>>부서</option>
							<option value="position"
								<c:if test="${param.searchType == 'position'}">selected</c:if>>직책</option>
