...
<head>
    ...
    <meta name="description" content="3부상조 - 인사 데이터 관리 1">
    <title>3부상조 - 인사 데이터 관리 1</title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;700&display=swap" rel="stylesheet">
    <link href="<c:url value='/resources/css/CSS.css' />" rel="stylesheet">
    <link href="<c:url value='resources/css/Header.css' />" rel="stylesheet">
    <link href="<c:url value='resources/css/Footer.css' />" rel="stylesheet">
    <link href="<c:url value='resources/css/CSS_name_Search' />" rel="stylesheet">
    ...
    <style type="text/css">
        ...
        table thead {
            background-color: #003399; /* Sky blue theme */
            color: #fff;
        }
...
<main>
    ...
    <table>
        ...
        <tbody>
            <tr><td><input type="checkbox" checked></td><td></td><td>김진수</td><td></td><td></td><td></td><td>정상</td><td></td><td></td><td>정상</td></tr>
            <tr><td><input type="checkbox"></td><td>001211</td><td>박진수</td><td>총무1팀</td><td>주임</td><td>2</td><td>정상</td><td>24.1.1</td><td></td><td>정상</td></tr>
