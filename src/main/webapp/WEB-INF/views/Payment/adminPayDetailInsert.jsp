...
<body>
    <main style="margin: 80px auto auto;">
        ...
        <div class="container">
            ...
            <div class="container2">
                ...
                <form id="payForm" action="/admin_Pay_Insert_Ok" method="post">
                    <div class="pay">
                        <div>기본급 : </div>
                        <div class="choice">
                    ...
                    <div>
                        <input type="button" class="button2" value="저장하기" onclick="adminPayDetailInsertOk()">
    ...
    <script type="text/javascript">
        ...
        function adminPayDetailInsertOk() {
