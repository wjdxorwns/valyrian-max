						...
						<c:otherwise>
							<c:forEach var="user" items="${userList}">
								<tr>
									<td>${user.emp_name}</td>
									<td>
										<select onchange="onPermissionChange('${user.emp_idx}', 'canAccessEmployee', this.value)">
											<option value="승인"
												${user.canAccessEmployee == '승인' ? 'selected' : ''}>승인</option>
											<option value="미승인"
												${user.canAccessEmployee == '미승인' ? 'selected' : ''}>미승인</option>
										</select>
									</td>
									<td>
										<select onchange="onPermissionChange('${user.emp_idx}', 'canAccessWorktype', this.value)">
											<option value="승인"
												${user.canAccessWorktype == '승인' ? 'selected' : ''}>승인</option>
											<option value="미승인"
												${user.canAccessWorktype == '미승인' ? 'selected' : ''}>미승인</option>
										</select>
									</td>
									<td>
										<select onchange="onPermissionChange('${user.emp_idx}', 'canAccessPersonnel', this.value)">
											<option value="승인"
												${user.canAccessPersonnel == '승인' ? 'selected' : ''}>승인</option>
											<option value="미승인"
												${user.canAccessPersonnel == '미승인' ? 'selected' : ''}>미승인</option>
										</select>
									</td>
									<td>
										<select onchange="onPermissionChange('${user.emp_idx}', 'canAccessSalary', this.value)">
											<option value="승인"
												${user.canAccessSalary == '승인' ? 'selected' : ''}>승인</option>
											<option value="미승인"
												${user.canAccessSalary == '미승인' ? 'selected' : ''}>미승인</option>
										</select>
									</td>
									<td>
										<select onchange="onPermissionChange('${user.emp_idx}', 'canAccessVacation', this.value)">
											<option value="승인"
												${user.canAccessVacation == '승인' ? 'selected' : ''}>승인</option>
											<option value="미승인"
												${user.canAccessVacation == '미승인' ? 'selected' : ''}>미승인</option>
										</select>
									</td>
								</tr>
							</c:forEach>
