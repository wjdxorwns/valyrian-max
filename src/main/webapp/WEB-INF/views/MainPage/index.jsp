				...
				<div class="container">
					<ul class="shortcut-list clearfix">
						...
						<li class="shortcut-list-item"><c:choose>
								...
								<c:otherwise>
									<!-- 로그인 후: 켈린더 -->
									<a href="calendar?emp_idx=${sessionScope.employeeVO.emp_idx}">
			...
			<div class="article recent-posts">
				<div class="container clearfix">
					...
					<div class="graphic-box clearfix">
						<ul class="post-list">
							<li class="post-item"><a href="noticeone?emp_idx=${sessionScope.employeeVO.emp_idx}">
									<h4 class="post-title">2025년 상반기 워크숍 안내</h4>
									<p class="post-meta">
										<span>작성자: 김관리</span> <span>작성일: 2025/04/23</span>
									</p>
							</a></li>
							<li class="post-item"><a href="noticetwo?emp_idx=${sessionScope.employeeVO.emp_idx}">
