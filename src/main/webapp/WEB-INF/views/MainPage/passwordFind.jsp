        ...
        $.ajax({
            ...
            success: function(response) {
                if (response === "success") {
                    ...
                    let errorMsg = response.startsWith("fail: ") ? response.substring(6) : response;
                    if (errorMsg === "등록되지 않은 이메일입니다") {
                        errorMsg = "가입된 이메일이 아닙니다.";
                        window.location.href = "<c:url value='/passwordFind' />"; // 가입되지 않은 이메일일 때 페이지 리다이렉트
