				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td><c:forEach var="v" items="${emp_idx}">
									<!-- Employee(직원) 테이블 -->
				...
				<table>
					...
					<tbody id="vacationTableBody">
						<tr>
							...
							<td>${vacation_type }<select name="vacation"
								onchange="changeDateType(this)">
					...
					<tfoot>
						<tr>
							<th rowspan="4" style="background-color: #e0f4ff;">첨부파일</th>
							<td colspan="5" style="height: 150px;"></td>
						</tr>
						<tr>
							<td colspan="5"><input type="file" name="vacationFile"
								multipartfile> <input type="button" value="보내기"
								onclick=""></td>
						</tr>
					</tfoot>
				</table>
				<input id="button" type="button" value="신청"
					onclick="request_vacation()"> <input id="button"
					type="button" value="삭제" onclick="deleteSelectedRow()"> <input
					id="button" type="button" value="추가" onclick="addRow()">
			</div>
