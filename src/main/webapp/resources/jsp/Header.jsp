				...
				<div class="container">
					...
					<nav>
						<ul class="nav-menu">
							<c:choose>
								<c:when
									test='${sessionScope.permissionvo.can_access_employee eq 1 or sessionScope.employeeVO.dept_name eq "슈퍼관리자"}'>
								...
								<c:otherwise>
									<li class="nav-item"><a href="#"
											onclick="alert('인사 관리 권한이 없습니다.'); return false;">인사 관리</a>
										<ul class="dropdown-menu">
											<li><a href="#" onclick="alert('인사 관리 권한이 없습니다.'); return false;">근무지 정보
													관리</a></li>
											<li><a href="#" onclick="alert('인사 관리 권한이 없습니다.'); return false;">직원 현황
													관리</a></li>
											<li><a href="#" onclick="alert('인사 관리 권한이 없습니다.'); return false;">퇴직자 정보
													관리</a></li>
											<li><a href="#" onclick="alert('인사 관리 권한이 없습니다.'); return false;">신규 직원
													등록</a></li>
										</ul>
									</li>
								</c:otherwise>
							...
							<c:choose>
								<c:when
									test='${sessionScope.permissionvo.can_access_salary eq 1 or sessionScope.employeeVO.dept_name eq "슈퍼관리자"}'>
								...
								<c:otherwise>
									<li class="nav-item"><a href="/pay"
											onclick="alert('급여 관리 권한이 없습니다.'); return false;">급여 관리</a>
										<ul class="dropdown-menu">
											<li><a href="/paylist" onclick="alert('급여 관리 권한이 없습니다.'); return false;">직원
													급여
													리스트</a></li>
											<li><a href="${pageContext.request.contextPath}/adminPay"
													onclick="alert('급여 관리 권한이 없습니다.'); return false;">개인 급여
													명세서 조회</a></li>
										</ul>
									</li>
								</c:otherwise>
							...
							<c:choose>
								<c:when
									test='${sessionScope.permissionvo.can_access_vacation eq 1 or sessionScope.employeeVO.dept_name eq "슈퍼관리자"}'>
								...
								<c:otherwise>
									<li class="nav-item"><a href="#"
											onclick="alert('휴가 관리 권한이 없습니다.'); return false;">휴가 관리</a>
										<ul class="dropdown-menu">
											...
											<li><a href="#" onclick="alert('휴가 관리 권한이 없습니다.'); return false;">휴가현황</a>
											</li>
										</ul>
									</li>
								</c:otherwise>
							...
							<c:choose>
								<c:when
									test='${sessionScope.employeeVO.dept_name eq "슈퍼관리자"}'>
									<li class="nav-item"><a href="/Permission?emp_idx=${sessionScope.employeeVO.emp_idx}">권한 및 전자결제 관리</a>
										<ul class="dropdown-menu">
							...
							<c:if test="${not empty sessionScope.userVO}">
								<li class="nav-item notification-icon"><a href="#" title="알림"
										onclick="openNotificationModal(event);"> <i class="fas fa-bell"></i> <span
											class="notification-badge">3</span>
									</a></li>
							</c:if>
							<c:if test="${not empty sessionScope.userVO}">
