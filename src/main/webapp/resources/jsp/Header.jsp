			...
			<nav>
				<ul class="nav-menu">
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="nav-item">
								<a href="/pay?emp_idx=${sessionScope.employeeVO.emp_idx}" onclick="alert('급여 관리 권한이 없습니다.'); return false;">급여 관리</a>
								<ul class="dropdown-menu">
									<li><a href="/paylist?emp_idx=${sessionScope.employeeVO.emp_idx}" onclick="alert('급여 관리 권한이 없습니다.'); return false;">직원 급여 리스트</a></li>
