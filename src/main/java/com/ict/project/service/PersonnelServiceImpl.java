...
public class PersonnelServiceImpl implements PersonnelService{
	...
	// 작성자: 김재겸 (05-13)
		...
		@Override
		public boolean updateWorkArrangement(String empIdx, String location, String attitudeType, String team, String requestText) {
	    	try {
	        	personnelDAO.updateWorkArrangement(empIdx, location, attitudeType, team, requestText);
	      	  	return true;
	    	} catch (Exception e) {
	       	 	e.printStackTrace();
	       	 	return false;
