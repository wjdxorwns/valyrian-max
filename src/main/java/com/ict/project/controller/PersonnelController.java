 ...
 // 관리자 메인 급여 페이지 이동
    ...
    // 한찬욱 
 	...
 	// 작성자: 김재겸 (05-13)
 		...
 		public ModelAndView updateWorkArrangement(
 				HttpSession session,
 				@RequestParam("emp_idx") String emp_idx,
 				@RequestParam("location") String location,
 				@RequestParam("attitude_type") String attitudeType,
                 @RequestParam("team") String team,
                 @RequestParam("request_text") String requestText) {

 			boolean success = personnelService.updateWorkArrangement(emp_idx, location, attitudeType, team, requestText);
