...
public class PersonnelDAO {
    ...
    public void updateWorkArrangement(String empIdx, String location, String attitudeType, String team, String requestText) {
        Map<String, Object> params = new HashMap<>();
        params.put("emp_idx", empIdx);
        params.put("location", location);
        params.put("attitude_type", attitudeType);
        params.put("team", team);
        params.put("request_text", requestText);
        
        // Employee 테이블 업데이트
        sqlSession.update("personnel.updateWorkArrangement", params);
        // Request 테이블에 새로운 요청 추가
        sqlSession.insert("personnel.insertWorkArrangementRequest", params);
    }
