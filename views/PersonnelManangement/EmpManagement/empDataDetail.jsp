...
<meta name="description" content="3부상조 - 직원상세조회">
<title>3부상조 - 직원상세조회</title>
      ...
      <table class="form-table">
        <tr>
         <td><label>생년월일</label></td>
          <td><input type="date" value="1999-01-01"></td>
          <td><label>성별</label></td>
           <td><input type="text" value="남성"></td>
        ...
        <tr>
          ...
          <td><label>상세주소</label></td>
           <td><input type="text" value="광화문 광화로 광화오피스"></td>
        ...
        <tr>
          ...
          <td><input type="date" value="2024-01-01"></td>
        	...
        	<td><input type="text" value="경기도 연천지부" placeholder="보직이동에서 입력한 값"></td>
         	 <td><label>직책</label></td>
          <td><input type="text" value="사원" placeholder=""></td>
        </tr>
        <tr>
       ...
       <td><input type="text" value="정상"></td>
        </tr>
